...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome To Online Music Store!");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            for (int i = 0; i < user.length(); i++)
            {
                if (user.charAt(i) == '\'')
                {
                    user = user.substring(0, i) + "''" + user.substring(i + 1, user.length()); //in sql, to escape ', just double them. '' -> '
            ...
            {
                dispose();
                Dashboard d = new Dashboard(user, pass);
                d.setVisible(true);
            }
            else
            {
